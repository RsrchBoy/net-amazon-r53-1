...
This document describes version 0.001 of Net::Amazon::R53 - released December 21, 2012 as part of Net-Amazon-R53.
...
These attributes are lazily constructed from another source (e.g. required attributes, external source, some combo of the two). You can, but are generally recommended to not, set these values at construction time.
